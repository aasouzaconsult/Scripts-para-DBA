...
--Declare @User varchar(20)= 'SA'
Declare @UserDestino varchar(20)= 'Externo'
Declare @Pass varchar(20) = '123'
EXEC master.dbo.sp_addlinkedserver @nmserver, 'SQL Server'
--EXEC master.dbo.sp_addlinkedsrvlogin @nmserver,'False',
	@User ,@UserDestino,@Pass 
EXEC master.dbo.sp_addlinkedsrvlogin @nmserver, 'False',
	NULL,@UserDestino,@Pass

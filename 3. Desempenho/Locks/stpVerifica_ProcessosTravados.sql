...
BEGIN
	...
	-- Auxiliares
	--Select * From sys.dm_exec_sessions -- Sessões ativas
	--Select * From sys.dm_exec_requests -- Requisições solicitadas
	--Select * From sys.dm_exec_connections -- Conexões ativas

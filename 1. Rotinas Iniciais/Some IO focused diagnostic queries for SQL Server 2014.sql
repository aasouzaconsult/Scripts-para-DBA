...
-- Some I/O focused diagnostic queries for SQL Server 2012/2014
-- Glenn Berry
...
-- Top Cached SPs By Total Logical Reads (Query 13)
...
-- Top Cached SPs By Total Physical Reads (Query 14)
...
-- Top Cached SPs By Total Logical Writes (Query 15)  
...
-- Lists the top statements by average input/output usage for the current database  (Query 16) 
...
-- Possible Bad NC Indexes (writes > reads)  (Query 17)
...
-- Missing Indexes for current database by Index Advantage  (Query 18)
...
-- Get fragmentation info for all indexes above a certain size in the current database  (Query 19)
